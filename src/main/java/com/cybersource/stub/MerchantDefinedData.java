...
/**
 * <p>Java class for MerchantDefinedData complex type</p>.
 * 
 ...
 *         <element name="mddField" type="{urn:schemas-cybersource-com:transaction-data-1.219}MDDField" maxOccurs="100" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class MerchantDefinedData {
     ...
     * This is why there is not a <CODE>set</CODE> method for the mddField property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the mddField property.
     */
    public List<MDDField> getMddField() {
        if (mddField == null) {
            mddField = new ArrayList<>();
        }
