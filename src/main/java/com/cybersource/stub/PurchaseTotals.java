...
/**
 * <p>Java class for PurchaseTotals complex type</p>.
 * 
 ...
 *         <element name="dutyAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 ...
 *         <element name="freightAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="freightAmountSign" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         <element name="foreignAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="foreignCurrency" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         <element name="originalAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="originalCurrency" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         <element name="exchangeRate" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 ...
 *         <element name="serviceFeeAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="subtotalAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="shippingAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="handlingAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="shippingHandlingAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="shippingDiscountAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="giftWrapAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="insuranceAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="invoiceAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="totalAmountBeforeBenefits" type="{urn:schemas-cybersource-com:transaction-data-1.219}amount" minOccurs="0"/>
 *         <element name="anticipatedAmount" type="{urn:schemas-cybersource-com:transaction-data-1.219}RestrictedString" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class PurchaseTotals {
    ...
    protected String totalAmountBeforeBenefits;
    protected String anticipatedAmount;
    ...
    /**
     * Gets the value of the totalAmountBeforeBenefits property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getTotalAmountBeforeBenefits() {
        return totalAmountBeforeBenefits;
    }

    /**
     * Sets the value of the totalAmountBeforeBenefits property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setTotalAmountBeforeBenefits(String value) {
        this.totalAmountBeforeBenefits = value;
    }
     ...
     *     
     */
    public void setAnticipatedAmount(String value) {
        this.anticipatedAmount = value;
    }
